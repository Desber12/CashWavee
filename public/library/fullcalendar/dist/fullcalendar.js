...
----------------------------------------------------------------------------------------------------------------------*/
// Given the scrollbar widths of some other container, create border/margins on rowEls in order to match the left
...
// Undoes compensateScroll and restores all border/margins
...
// Returns a rectangle with absolute coordinates: left, right (exclusive), top, bottom (exclusive).
// Origin is optional.
// WARNING: given element can't have border
...
// WARNING: given element can't have border (which will cause offsetWidth/offsetHeight to be larger).
// NOTE: should use clientLeft/clientTop, but very unreliable cross-browser.
...
var View = /** @class */ (function (_super) {
    ...
    function View(calendar, viewSpec) {
        ...
        _this.eventorderpecs = util_1.parseFieldSpecs(_this.opt('eventOrder'));
        // legacy
        if (_this['initialize']) {
            _this['initialize']();
        }
...
var EventRenderer = /** @class */ (function () {
    ...
    EventRenderer.prototype.compareEventSegs = function (seg1, seg2) {
        ...
        return r1.startMs - r2.startMs || // earlier events go first
            ...
            util_1.compareByFieldSpecs(f1.eventDef, f2.eventDef, this.view.eventorderpecs, f1.eventDef.miscProps, f2.eventDef.miscProps);
    };
