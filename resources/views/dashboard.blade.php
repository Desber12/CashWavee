                            ...
                            <ul class="list-unstyled list-unstyled-borders">
                                <li class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <div class="media-title">Sandy Yopa</div>
                                ...
                                <li class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <div class="media-title">Desber</div>
                                ...
                                <li class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <div class="media-title">Samuel</div>
                                ...
                                <li class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <div class="media-title">John LBF</div>
                                ...
                                <div class="col-6 col-sm-3 col-lg-3 mb-md-0 mb-4">
                                    <div class="avatar-item mb-0">
                                        <img alt="image" src="{{ asset('img/avatar/avatar-5.png') }}"
                                            class="img-fluid" data-toggle="tooltip" title="Desber">
                                ...
                                <div class="col-6 col-sm-3 col-lg-3 mb-md-0 mb-4">
                                    <div class="avatar-item mb-0">
                                        <img alt="image" src="{{ asset('img/avatar/avatar-1.png') }}"
                                            class="img-fluid" data-toggle="tooltip" title="Samuel">
                                ...
                                <div class="col-6 col-sm-3 col-lg-3 mb-md-0 mb-4">
                                    <div class="avatar-item mb-0">
                                        <img alt="image" src="{{ asset('img/avatar/avatar-2.png') }}"
                                            class="img-fluid" data-toggle="tooltip" title="John LBF">
                                        <div class="avatar-badge" title="Admin" data-toggle="tooltip"><i
                                                class="fas fa-cog"></i></div>
                                    </div>
                                </div>
                                    ...
                                    <ul class="list-unstyled list-unstyled-borders">
                                        <li class="media">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <div class="text-muted text-small">by <a href="#">Desber</a>
                                        ...
                                        <li class="media">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <div class="text-muted text-small">by <a href="#">John</a>
                                                    <div class="bullet"></div> Sunday
                                                </div>
                                            </div>
                                        </li>
                                        <li class="media">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <div class="media-title"><a href="#">Iphone 15 Pro</a></div>
                            ...
                            <ul class="list-unstyled list-unstyled-borders">
                                <li class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <div class="text-small text-muted">Sandy Yopa <div class="bullet"></div>
                                ...
                                <li class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <div class="text-small text-muted">Desber <div class="bullet"></div> 4 Min
                                        </div>
                                    </div>
                                </li>
                                <li class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <div class="text-small text-muted">Samuel<div class="bullet"></div> 8 Min
                                        </div>
                                    </div>
                                </li>
                                <li class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <div class="text-small text-muted">John LBF<div class="bullet"></div> 21
                                            Min</div>
                                    </div>
                                </li>
                            </ul>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#" class="font-weight-600"><img
                                                        src="{{ asset('img/avatar/avatar-1.png') }}" alt="avatar"
                                                        width="30" class="rounded-circle mr-1"> Sandy Yopa</a>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#" class="font-weight-600"><img
                                                        src="{{ asset('img/avatar/avatar-1.png') }}" alt="avatar"
                                                        width="30" class="rounded-circle mr-1"> Desber </a>
                                            </td>
                                            <td>
                                                <a class="btn btn-primary btn-action mr-1" data-toggle="tooltip"
                                                    title="Edit"><i class="fas fa-pencil-alt"></i></a>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#" class="font-weight-600"><img
                                                        src="{{ asset('img/avatar/avatar-1.png') }}" alt="avatar"
                                                        width="30" class="rounded-circle mr-1"> Samuel</a>
                                            </td>
                                            <td>
                                                <a class="btn btn-primary btn-action mr-1" data-toggle="tooltip"
                                                    title="Edit"><i class="fas fa-pencil-alt"></i></a>
